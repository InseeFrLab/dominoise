...
![](reference/figures/README-tradeoff-1.png)
...
| Function | Purpose |
|----|----|
| [`pm_params()`](https://inseefrlab.github.io/dominoise/reference/pm_params.md) | container for every policy and mechanism choice |
| [`pm_calib_diff()`](https://inseefrlab.github.io/dominoise/reference/pm_calib_diff.md), [`pm_commit_diff()`](https://inseefrlab.github.io/dominoise/reference/pm_commit_diff.md) | step 1 — explore and set `sigma_eps` |
| [`pm_calib_dominance()`](https://inseefrlab.github.io/dominoise/reference/pm_calib_dominance.md), [`pm_suggest_n()`](https://inseefrlab.github.io/dominoise/reference/pm_suggest_n.md), [`pm_commit_dominance()`](https://inseefrlab.github.io/dominoise/reference/pm_commit_dominance.md) | step 2 — explore and set `sigma_nu` and `n` |
| [`pm_plot_risk_profile()`](https://inseefrlab.github.io/dominoise/reference/pm_plot_risk_profile.md), [`pm_plot_risk_max()`](https://inseefrlab.github.io/dominoise/reference/pm_plot_risk_max.md), [`pm_plot_tradeoff()`](https://inseefrlab.github.io/dominoise/reference/pm_plot_tradeoff.md) | the paper’s calibration figures |
| [`pm_draws()`](https://inseefrlab.github.io/dominoise/reference/pm_draws.md), [`pm_perturb()`](https://inseefrlab.github.io/dominoise/reference/pm_perturb.md) | derive the draws from the keys, apply the mechanism |
| [`assess_loss_expectation()`](https://inseefrlab.github.io/dominoise/reference/assess_loss_expectation.md), [`assess_loss_ci()`](https://inseefrlab.github.io/dominoise/reference/assess_loss_ci.md) | a-priori utility, conditional on `rho` |
| [`assess_risk_I()`](https://inseefrlab.github.io/dominoise/reference/assess_risk_I.md), [`assess_risk_II()`](https://inseefrlab.github.io/dominoise/reference/assess_risk_II.md) | a-priori risk measures |
| [`assess_utility_empirical()`](https://inseefrlab.github.io/dominoise/reference/assess_utility_empirical.md), [`assess_risk_empirical()`](https://inseefrlab.github.io/dominoise/reference/assess_risk_empirical.md) | ex-post metrics on the perturbed table |
...
leaves non-positive totals untouched and warns about them; they need a
separate treatment.
